    ...
    <div className="flex flex-col gap-y-6">
      <div className="flex justify-between">
        ...
        <div className="flex gap-2">
          <button className="btn btn-neutral btn-soft" onClick={() => handleClearFinishedProduct()}> Select Another Finished Product</button>
          <button className="btn btn-neutral btn-soft" onClick={() => previousStep()}>Previous Step</button>
