...
const MissingParameters = () => {
  ...
  return (
    <div className="flex flex-col gap-y-4 items-center justify-center">
      ...
      <button className="btn btn-neutral btn-soft" onClick={() => router.push(`/inventory/items/${lot?.item.referenceCode}/?id=${lot?.item.id}`)}>Set Parameters in Item Page</button>
    </div>
  )
}
