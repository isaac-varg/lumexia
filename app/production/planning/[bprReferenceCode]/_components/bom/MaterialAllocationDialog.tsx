...
const MaterialAllocationDialog = () => {
  ...
  const { selectedBomItem: material, selectedBomItemPurchasingRequests: requests, isLoading } = useBprDetailsSelection()
  const { getSelectedBomItemPurchasingRequests, } = useBprDetailsActions()
  ...
  useEffect(() => {
    getSelectedBomItemPurchasingRequests()

  }, [material, getSelectedBomItemPurchasingRequests])
