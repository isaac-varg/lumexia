...
import { bprNoteTypes as StaticBprNoteTypes } from "@/configs/staticRecords/bprNoteTypes"
...
const NotesAddMode = ({ setMode }: { setMode: Dispatch<SetStateAction<'view' | 'addNote' | 'addType'>> }) => {
  ...
  const form = useForm<Inputs>({ defaultValues: { content: '', noteTypeId: StaticBprNoteTypes.general } })
