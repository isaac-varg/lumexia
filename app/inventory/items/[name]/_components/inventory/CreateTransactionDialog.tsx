...
const CreateTransactionDialog = ({ lot }: { lot: Lot }) => {
  ...
  const [transactionType, setTransactionType] = useState<string>("601b5e2c-3fd2-4310-9a79-5a41244cdfd8");
  ...
  const handleSubmit = async (data: Inputs) => {
    ...
    const createData: CreateData = {
      ...
      systemNote: "Adjustment made via Woolrus.Item.LotDetails.CreateTransaction"
    };

    await transactionActions.createNew(createData);
        ...
        <div className="flex flex-col">
          ...
          <span className="flex gap-x-6">
            <button
              ...
              className={`px-4 py-4 w-32 border-2 border-emerald-200 bg-shutters-100 rounded-lg focus:outline-none focus:ring-0 focus:border-shutters-500 text-xl text-neutral-950 ${transactionType === "87c594f9-b49f-4889-9bc7-b840364a3698" ? "bg-emerald-200" : ""}`}
            >
              Add
            </button>
            <button
              ...
              className={`px-4 py-4 w-32 border-2 border-rose-200 bg-shutters-100 rounded-lg focus:outline-none focus:ring-0 focus:border-shutters-500 text-xl text-neutral-950 ${transactionType === "601b5e2c-3fd2-4310-9a79-5a41244cdfd8" ? "bg-rose-200" : ""}`}
            >
              Remove
            </button>
          </span>
