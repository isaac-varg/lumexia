  ...
  return (
    <div className="flex flex-col gap-y-4 h-full">
      <Layout.Row justify="end">
        ...
        />
        <button className={`btn  ${dateRangeMode === 'all' ? 'btn-accent' : 'btn-soft'}`}
          onClick={() => setDateRangeMode("all")}
        >
          All
        </button>
        <button className={`btn  ${dateRangeMode === 'yearToDate' ? 'btn-accent' : 'btn-soft'}`}
          onClick={() => setDateRangeMode("yearToDate")}
        >
          This Year
        </button>
        <button className={`btn  ${dateRangeMode === 'lastYear' ? 'btn-accent' : 'btn-soft'}`}
