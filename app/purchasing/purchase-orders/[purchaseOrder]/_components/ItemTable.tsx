...
const ItemTable = ({ orderItems, items, purchaseOrder }: ItemTableProps) => {
  ...
  const handleRowDelete = (row: any) => {
    ...
    createActivityLog("deletePurchaseOrderItem", 'purchaseOrder', purchaseOrder.id, {
  ...
  const handleItemSelection = async (item: Item) => {
    ...
    await createActivityLog('createPurchaseOrderItem', 'purchaseOrder', purchaseOrder.id, {
